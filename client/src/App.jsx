...
import PredictionDashboard from "./pages/PredictonDashboard";
import ChatDashboard from "./pages/ChatDashboard";
import { useAuthContext } from "./hooks/useAuthContext";

// Component to dynamically redirect /company/:companyId to its stocks page
const RedirectToStocks = () => {
  const { companyId } = useParams();
  return <Navigate to={`/dashboard/companies/${companyId}/stocks`} replace />;
};
      ...
      <BrowserRouter>
        ...
        <div className="pages">
          <Routes>
            ...
            <Route
              path="/dashboard"
              element={user ? <Navigate to="/dashboard/companies" replace /> : <Signup />}
            />
            <Route
            ...
            <Route
              ...
              element={user ? <RedirectToStocks /> : <Navigate to="/auth/login" />}
            />
